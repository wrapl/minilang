...
:mini:`fun buffered(Sequenc: :sequence, Siz: integer, F: function): sequence`
...
:mini:`fun parallel(Sequence: any, Max: :integer, Min: :integer, F: :function): nil | error`
...
:mini:`meth task(Arg₁: any, ..., Arg/: :any, F: :function): task`
...
:mini:`type task::queue < (MLFunction`
