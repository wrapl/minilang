...
:mini:`list`
   ...
   *Defined at line 3054 in src/ml_types.c*
...
:mini:`listnode`
   ...
   *Defined at line 3068 in src/ml_types.c*
...
:mini:`meth :length(List: list)` |rarr| :mini:`integer`
   ...
   *Defined at line 3210 in src/ml_types.c*
...
:mini:`meth :filter(List: list, Filter: function)` |rarr| :mini:`list`
   ...
   *Defined at line 3219 in src/ml_types.c*
...
:mini:`listslice`
   ...
   *Defined at line 3317 in src/ml_types.c*
...
:mini:`meth :pull(List: list)` |rarr| :mini:`any` or :mini:`nil`
   ...
   *Defined at line 3449 in src/ml_types.c*
...
:mini:`meth string(List: list, Seperator: string)` |rarr| :mini:`string`
   ...
   *Defined at line 3500 in src/ml_types.c*
...
:mini:`meth :sort(List: list, Compare: function)` |rarr| :mini:`List`
   *Defined at line 3587 in src/ml_types.c*
