...
:mini:`list`
   ...
   *Defined at line 3062 in src/ml_types.c*
...
:mini:`meth :filter(List: list, Filter: function)` |rarr| :mini:`list`
   ...
   *Defined at line 3227 in src/ml_types.c*
...
:mini:`meth [](List: list, Index: integer)` |rarr| :mini:`listnode` or :mini:`nil`
   ...
   *Defined at line 3278 in src/ml_types.c*

:mini:`listslice`
   A slice of a list.

   *Defined at line 3325 in src/ml_types.c*
...
:mini:`meth +(List₁: list, List₂: list)` |rarr| :mini:`list`
   ...
   *Defined at line 3475 in src/ml_types.c*
