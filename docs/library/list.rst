...
:mini:`list`
   ...
   *Defined at line 3056 in src/ml_types.c*
...
:mini:`meth :filter(List: list, Filter: function)` |rarr| :mini:`list`
   ...
   *Defined at line 3221 in src/ml_types.c*
...
:mini:`listslice`
   ...
   *Defined at line 3319 in src/ml_types.c*
...
:mini:`meth :push(List: list, Values...: any)` |rarr| :mini:`list`
   ...
   *Defined at line 3421 in src/ml_types.c*
...
:mini:`meth :pop(List: list)` |rarr| :mini:`any` or :mini:`nil`
   ...
   *Defined at line 3443 in src/ml_types.c*
...
:mini:`meth :pull(List: list)` |rarr| :mini:`any` or :mini:`nil`
   ...
   *Defined at line 3451 in src/ml_types.c*
...
:mini:`meth +(List₁: list, List₂: list)` |rarr| :mini:`list`
   ...
   *Defined at line 3469 in src/ml_types.c*
...
:mini:`meth string(List: list)` |rarr| :mini:`string`
   ...
   *Defined at line 3481 in src/ml_types.c*
...
:mini:`meth :sort(List: list)` |rarr| :mini:`List`
   *Defined at line 3582 in src/ml_types.c*

:mini:`meth :sort(List: list, Compare: function)` |rarr| :mini:`List`
   *Defined at line 3589 in src/ml_types.c*
