...
:mini:`list`
   ...
   *Defined at line 3281 in src/ml_types.c*
...
:mini:`meth [](List: list, Index: integer)` |rarr| :mini:`listnode` or :mini:`nil`
   ...
   *Defined at line 3514 in src/ml_types.c*

:mini:`listslice`
   A slice of a list.

   *Defined at line 3558 in src/ml_types.c*
...
:mini:`meth stringbuffer::append(Arg₁: stringbuffer, Arg₂: list)`
   *Defined at line 3600 in src/ml_types.c*
...
:mini:`meth :pop(List: list)` |rarr| :mini:`any` or :mini:`nil`
   ...
   *Defined at line 3691 in src/ml_types.c*
...
:mini:`meth :pull(List: list)` |rarr| :mini:`any` or :mini:`nil`
   ...
   *Defined at line 3699 in src/ml_types.c*
...
:mini:`meth string(List: list, Seperator: string)` |rarr| :mini:`string`
   ...
   *Defined at line 3750 in src/ml_types.c*

:mini:`meth :sort(List: list)` |rarr| :mini:`List`
   *Defined at line 3831 in src/ml_types.c*
