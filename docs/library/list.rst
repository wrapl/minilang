...
:mini:`list`
   ...
   *Defined at line 3283 in src/ml_types.c*
...
:mini:`listnode`
   ...
   *Defined at line 3297 in src/ml_types.c*
...
:mini:`listslice`
   ...
   *Defined at line 3560 in src/ml_types.c*
...
:mini:`meth [](List: list, From: integer, To: integer)` |rarr| :mini:`listslice`
   ...
   *Defined at line 3567 in src/ml_types.c*
...
:mini:`meth :pop(List: list)` |rarr| :mini:`any` or :mini:`nil`
   ...
   *Defined at line 3693 in src/ml_types.c*
...
:mini:`meth :copy(List: list)` |rarr| :mini:`list`
   ...
   *Defined at line 3709 in src/ml_types.c*
...
:mini:`meth +(List₁: list, List₂: list)` |rarr| :mini:`list`
   ...
   *Defined at line 3719 in src/ml_types.c*
...
:mini:`meth string(List: list)` |rarr| :mini:`string`
   ...
   *Defined at line 3731 in src/ml_types.c*
...
:mini:`meth string(List: list, Seperator: string)` |rarr| :mini:`string`
   ...
   *Defined at line 3752 in src/ml_types.c*

:mini:`meth :sort(List: list)` |rarr| :mini:`List`
   *Defined at line 3833 in src/ml_types.c*

:mini:`meth :sort(List: list, Compare: function)` |rarr| :mini:`List`
   *Defined at line 3840 in src/ml_types.c*
