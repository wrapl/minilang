...
:mini:`meth <>(Real₁: real, Int₂: integer)` |rarr| :mini:`integer`
   ...
   *Defined at line 1432 in src/ml_types.c*
...
:mini:`meth <>(Int₁: integer, Real₂: real)` |rarr| :mini:`integer`
   ...
   *Defined at line 1445 in src/ml_types.c*
