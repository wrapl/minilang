...
:mini:`number`
   ...
   *Defined at line 980 in src/ml_types.c*

:mini:`integer`
   :Parents: :mini:`number`

   *Defined at line 998 in src/ml_types.c*
...
:mini:`int64`
   ...
   *Defined at line 1011 in src/ml_types.c*
...
:mini:`meth integer(Arg₁: real)`
   *Defined at line 1099 in src/ml_types.c*

:mini:`real`
   :Parents: :mini:`number`

   *Defined at line 1104 in src/ml_types.c*

:mini:`double`
   :Parents: :mini:`real`

   *Defined at line 1111 in src/ml_types.c*

:mini:`meth integer(Real: real)` |rarr| :mini:`integer`
   Converts :mini:`Real` to an integer (using default rounding).

   *Defined at line 1142 in src/ml_types.c*
...
:mini:`meth real(Arg₁: int32)`
   *Defined at line 1194 in src/ml_types.c*

:mini:`meth real(Arg₁: int64)`
   *Defined at line 1199 in src/ml_types.c*

:mini:`meth real(Arg₁: integer)`
   *Defined at line 1210 in src/ml_types.c*

:mini:`meth ++(Int: integer)` |rarr| :mini:`integer`
   Returns :mini:`Int + 1`

   *Defined at line 1276 in src/ml_types.c*
...
:mini:`meth /(Int₁: integer, Int₂: integer)` |rarr| :mini:`integer` or :mini:`real`
   ...
   *Defined at line 1312 in src/ml_types.c*
...
:mini:`meth :mod(Int₁: integer, Int₂: integer)` |rarr| :mini:`integer`
   ...
   *Defined at line 1383 in src/ml_types.c*
