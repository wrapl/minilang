...
:mini:`number`
   ...
   *Defined at line 1113 in src/ml_types.c*

:mini:`integer`
   :Parents: :mini:`number`

   *Defined at line 1131 in src/ml_types.c*

:mini:`int32`
   :Parents: :mini:`integer`

   *Defined at line 1134 in src/ml_types.c*
...
:mini:`integer`
   ...
   *Defined at line 1191 in src/ml_types.c*

:mini:`meth integer(Arg₁: real)`
   *Defined at line 1232 in src/ml_types.c*
...
:mini:`meth real(Arg₁: int64)`
   *Defined at line 1332 in src/ml_types.c*
...
:mini:`meth ++(Int: integer)` |rarr| :mini:`integer`
   ...
   *Defined at line 1409 in src/ml_types.c*

:mini:`meth --(Int: integer)` |rarr| :mini:`integer`
   Returns :mini:`Int - 1`

   *Defined at line 1417 in src/ml_types.c*

:mini:`meth ++(Real: real)` |rarr| :mini:`real`
   Returns :mini:`Real + 1`

   *Defined at line 1425 in src/ml_types.c*

:mini:`meth --(Real: real)` |rarr| :mini:`real`
   Returns :mini:`Real - 1`

   *Defined at line 1433 in src/ml_types.c*
...
:mini:`meth !|(Int₁: integer, Int₂: integer)` |rarr| :mini:`integer`
   ...
   *Defined at line 1486 in src/ml_types.c*
...
:mini:`meth string(Arg₁: integer)`
   *Defined at line 2118 in src/ml_types.c*

:mini:`meth string(Arg₁: integer, Arg₂: integer)`
   *Defined at line 2125 in src/ml_types.c*

:mini:`meth string(Arg₁: real)`
   *Defined at line 2148 in src/ml_types.c*
...
:mini:`meth real(Arg₁: string)`
   *Defined at line 2179 in src/ml_types.c*
