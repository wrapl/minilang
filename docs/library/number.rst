...
:mini:`number`
   ...
   *Defined at line 933 in src/ml_types.c*

:mini:`integer`
   :Parents: :mini:`number`

   *Defined at line 951 in src/ml_types.c*

:mini:`int32`
   :Parents: :mini:`integer`

   *Defined at line 954 in src/ml_types.c*

:mini:`int64`
   :Parents: :mini:`integer`

   *Defined at line 964 in src/ml_types.c*
...
:mini:`double`
   ...
   *Defined at line 1064 in src/ml_types.c*
...
:mini:`meth real(Arg₁: integer)`
   *Defined at line 1163 in src/ml_types.c*

:mini:`meth ++(Int: integer)` |rarr| :mini:`integer`
   Returns :mini:`Int + 1`

   *Defined at line 1229 in src/ml_types.c*

:mini:`meth --(Int: integer)` |rarr| :mini:`integer`
   Returns :mini:`Int - 1`

   *Defined at line 1237 in src/ml_types.c*
...
:mini:`meth /(Int₁: integer, Int₂: integer)` |rarr| :mini:`integer` or :mini:`real`
   ...
   *Defined at line 1265 in src/ml_types.c*
...
:mini:`meth <>(Real₁: real, Int₂: integer)` |rarr| :mini:`integer`
   ...
   *Defined at line 1385 in src/ml_types.c*
...
:mini:`meth <>(Int₁: integer, Real₂: real)` |rarr| :mini:`integer`
   ...
   *Defined at line 1398 in src/ml_types.c*
...
:mini:`meth <>(Real₁: real, Real₂: real)` |rarr| :mini:`integer`
   ...
   *Defined at line 1411 in src/ml_types.c*

:mini:`meth string(Arg₁: integer)`
   *Defined at line 1913 in src/ml_types.c*

:mini:`meth string(Arg₁: integer, Arg₂: integer)`
   *Defined at line 1920 in src/ml_types.c*

:mini:`meth string(Arg₁: real)`
   *Defined at line 1943 in src/ml_types.c*
