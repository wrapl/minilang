...
:mini:`fun xml::escape(Strin: string): string`
...
:mini:`type xml::element < (mlxml, MLSequence`
   An XML element node.
...
:mini:`type xml::filter < (MLFunction`
   An XML filter.
...
:mini:`type xml::text < (mlxml, MLString`
   A XML text node.
