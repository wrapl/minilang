...
:mini:`meth ?(Value: any)` |rarr| :mini:`type`
   ...
   *Defined at line 235 in src/ml_types.c*
...
:mini:`meth :in(Value: any, Type: type)` |rarr| :mini:`Value` or :mini:`nil`
   ...
   *Defined at line 242 in src/ml_types.c*
...
:mini:`meth #(Value: any)` |rarr| :mini:`integer`
   ...
   *Defined at line 299 in src/ml_types.c*
...
:mini:`meth =(Value₁: any, Value₂: any)` |rarr| :mini:`Value₂` or :mini:`nil`
   ...
   *Defined at line 307 in src/ml_types.c*
...
:mini:`meth !=(Value₁: any, Value₂: any)` |rarr| :mini:`Value₂` or :mini:`nil`
   ...
   *Defined at line 316 in src/ml_types.c*

:mini:`meth string(Value: any)` |rarr| :mini:`string`
   Returns a general (type name only) representation of :mini:`Value` as a string.

   *Defined at line 325 in src/ml_types.c*
...
:mini:`meth list()`
   *Defined at line 3309 in src/ml_types.c*

:mini:`meth list(Arg₁: tuple)`
   *Defined at line 3313 in src/ml_types.c*

:mini:`meth map()`
   *Defined at line 3881 in src/ml_types.c*
