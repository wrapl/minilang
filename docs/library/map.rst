...
:mini:`map`
   ...
   *Defined at line 3504 in src/ml_types.c*
...
:mini:`meth [](Map: map, Key: any)` |rarr| :mini:`mapnode`
   ...
   *Defined at line 3783 in src/ml_types.c*
...
:mini:`meth :insert(Map: map, Key: any, Value: any)` |rarr| :mini:`any` or :mini:`nil`
   ...
   *Defined at line 3855 in src/ml_types.c*
...
:mini:`meth +(Map₁: map, Map₂: map)` |rarr| :mini:`map`
   ...
   *Defined at line 3973 in src/ml_types.c*
...
:mini:`meth string(Map: map)` |rarr| :mini:`string`
   ...
   *Defined at line 4007 in src/ml_types.c*
