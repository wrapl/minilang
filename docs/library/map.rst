...
:mini:`map`
   ...
   *Defined at line 3640 in src/ml_types.c*
...
:mini:`meth :size(Map: map)` |rarr| :mini:`integer`
   ...
   *Defined at line 3858 in src/ml_types.c*
...
:mini:`meth stringbuffer::append(Arg₁: stringbuffer, Arg₂: map)`
   *Defined at line 4049 in src/ml_types.c*
...
:mini:`meth string(Map: map)` |rarr| :mini:`string`
   ...
   *Defined at line 4143 in src/ml_types.c*
