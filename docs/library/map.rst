...
:mini:`map`
   ...
   *Defined at line 3607 in src/ml_types.c*
...
:mini:`meth ::(Map: map, Key: string)` |rarr| :mini:`mapnode`
   ...
   *Defined at line 3946 in src/ml_types.c*
...
:mini:`meth :delete(Map: map, Key: any)` |rarr| :mini:`any` or :mini:`nil`
   ...
   *Defined at line 3976 in src/ml_types.c*

:mini:`meth stringbuffer::append(Arg₁: stringbuffer, Arg₂: map)`
   *Defined at line 4016 in src/ml_types.c*
...
:mini:`meth +(Map₁: map, Map₂: map)` |rarr| :mini:`map`
   ...
   *Defined at line 4080 in src/ml_types.c*
