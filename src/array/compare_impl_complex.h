...
COMPARE_ROW_IMPL(NAME, OP, LEFT, complex_float, LTYPE, double) \
COMPARE_ROW_IMPL(NAME, OP, LEFT, complex_double, LTYPE, double)
...
COMPARE_ROW_VALUE_IMPL(NAME, OP, complex_float, double) \
COMPARE_ROW_VALUE_IMPL(NAME, OP, complex_double, double)
...
COMPARE_ROW_LEFT_IMPL(NAME, OP, complex_float, double) \
COMPARE_ROW_LEFT_IMPL(NAME, OP, complex_double, double)
