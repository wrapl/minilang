...
#define ML_COFUNCTION2(NAME, FUNCTION) static ml_value_t *FUNCTION(ml_state_t *State, int Count, ml_value_t **Args); \
\
ml_cfunction_t NAME[1] = {{MLCoFunctionT, FUNCTION, NULL}}; \
\
static ml_value_t *FUNCTION(ml_state_t *State, int Count, ml_value_t **Args)
